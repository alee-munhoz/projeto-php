...
try {
    // Prepara a consulta para obter os produtos da categoria 'enfeites' com ordenação
    $query = $pdo->prepare("SELECT id, name, description, price, image FROM products WHERE category = 'enfeites' ORDER BY price $order_by");
    $query->execute();
...
<main>
    ...
    <div class="filter-form">
        <form method="GET" action="enfeites.php">
