...
try {
    // Prepara a consulta para obter os produtos da categoria 'arvores' com ordenação
    $query = $pdo->prepare("SELECT id, name, description, price, image FROM products WHERE category = 'arvores' ORDER BY price $order_by");
    $query->execute();
...
<main>
    ...
    <div class="filter-form">
        <form method="GET" action="arvores.php">
        ...
        <?php if (!empty($produtos)): ?>
            <?php foreach ($produtos as $produto): ?>
                <div class="product-card">
                    ...
                    <!-- Alterado para usar a classe add-to-cart-btn -->
